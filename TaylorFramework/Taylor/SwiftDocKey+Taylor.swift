//
//  SwiftDocKey+Taylor.swift
//  Taylor
//
//  Created by Andrei Vacaruc on 11/4/16.
...
extension SwiftDocKey {
    static func publicGet2<T>(key: SwiftDocKey, _ dictionary: [String: SourceKitRepresentable]) -> T? {
     ...
     */
    static func publicGetKind(dictionary: [String: SourceKitRepresentable]) -> String? {
     ...
     */
    static func publicGetSyntaxMap(dictionary: [String: SourceKitRepresentable]) -> [SourceKitRepresentable]? {
     ...
     */
    static func publicGetOffset(dictionary: [String: SourceKitRepresentable]) -> Int64? {
